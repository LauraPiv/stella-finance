...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-12 text-sm text-zinc-700">
      ...
      <h1 className="mt-4 text-2xl font-semibold text-zinc-900">Termos de Uso</h1>
      <p className="mt-1 text-xs text-zinc-400">Última atualização: julho de 2026</p>

      <div className="mt-8 flex flex-col gap-6">
        <section>
          <h2 className="font-medium text-zinc-900">1. O que é a Stella</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="font-medium text-zinc-900">2. Sua conta</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="font-medium text-zinc-900">3. Uso permitido</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="font-medium text-zinc-900">4. Cancelamento</h2>
          <p className="mt-1">
